...
enum {
	SACOOP_CREATE_PED = LIBRG_EVENT_LAST,
	SACOOP_CREATE_VEHICLE,
	SACOOP_CREATE_OBJECT,

	SACOOP_SEND_MESSAGE,
	SACOOP_RECEIVE_MESSAGE,

	SACOOP_START_MISSION_SCRIPT,

	SACOOP_GET_LUA_SCRIPT,

	SACOOP_PED_IS_DEAD,
	SACOOP_BULLET_SYNC,
	SACOOP_RESPAWN_AFTER_DEATH,

	SACOOP_DISCONNECT,
	SACOOP_CONNECT,

	SACOOP_SPAWN_ALLOWED,

	SACOOP_RECEIVE_SPD_UPDATE,

	SACOOP_DO_SOMETHING_ELSE,
};
